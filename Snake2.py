...
class Snake:
	def __init__(self, root):
		self.root = root
		self.init_score()
		self.my_canvas = tk.Canvas(root, width=WIDTH, height=HEIGHT, bg="black", highlightthickness=1, highlightbackground="gray")
	...
	def check_if_eaten(self):
		if self.head_position == self.my_canvas.coords("food") or self.snake_positions[1] == self.my_canvas.coords("food"):
			self.score += 1
